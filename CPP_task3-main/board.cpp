...
void board::make(){
    ...
    vertexes_[34] = vertex(34, {resourceTypes::wood, resourceTypes::sheep, resourceTypes::wheat}, 0, {&vertexes_[33], &vertexes_[35], &vertexes_[44]},{3,4,5});
    ...
    hexagons_[8]=hexagon(8, 11, resourceTypes::wood, {&vertexes_[18], &vertexes_[19], &vertexes_[20], &vertexes_[29], &vertexes_[30], &vertexes_[31]}, {edges_[25], edges_[26], edges_[41], edges_[42], edges_[35], edges_[34]});
